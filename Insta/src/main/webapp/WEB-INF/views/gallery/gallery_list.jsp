...
<div class="G_container">
	...
	<div class="gallery_page_listing">
		...
		<div class="btn_addImg_container">
			<button id="btn_addImg" class="btn_gallery_addimg">사진추가</button>	
		</div>	
	</div>
              	...
              	<div class="G_popInnerBox">
                     ...
                     <div class="gallery_list_image">
                           <div class="gallery_list_box">
                           	...
                           	<input type="text" name="input_file" id="image_txt" class="gallery_image_text">
