...
<%@ include file="../common/top.jsp" %>
	...
	<h2 class="font2_style">Board upload_page</h2>
	...
	<input type="hidden" id="boardNum" name="boardNum" value="B0000001" />
		<input type="text" name="text_content" id="text_content" class="image_txt" placeholder="사진(이미지) 제목 또는 이름을 입력해주세요">		
     ...
     <div class="post_upload_button">       
        <input type="button" value="추가" id="btn_add" class="btn_add_board"/>
        <input type="button" id="btn_cancel" class="btn_add_board" value="취소">
     </div>           
