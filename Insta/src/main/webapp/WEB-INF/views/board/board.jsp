...
<title>Insert title here</title>
    ...
    <link rel="stylesheet" href="/css/postwrite.cs?s">
...
<div class="postWriteContainer">
	<h2 class="use_main_page_title"><a type="hidden" href="postwrite">글 작성</a></h2>
	
	<div class="bookmark-page-listing2">
		<div id="click_img" class="bookmark_container2">
		<c:forEach var="data" items="${ boardList}" varStatus="num">
			<div class="bookmark_listing">
				<div class="bookmark_image2">
